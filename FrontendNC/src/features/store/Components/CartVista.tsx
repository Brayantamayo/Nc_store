        ...
        <>
          ...
          >
            <div className={styles.header}>
              ...
              <button onClick={() => toggleCart(false)} className={styles.closeBtn}>
                <X size={24} />
              </button>
            </div>
            ...
            <div className={styles.content}>
              {items.length === 0 ? (
                <div className={styles.empty}>
                  ...
                  <Link to="/coleccion" onClick={() => toggleCart(false)} className={styles.emptyLink}>
                    Ver Colección
                  </Link>
                </div>
              ) : (
            ...
            {items.length > 0 && (
              <div className={styles.footer}>
                ...
                <Link to="/carrito" onClick={() => toggleCart(false)} className={styles.checkoutBtn}>
                  Finalizar Pedido
                </Link>
              </div>
            )}
